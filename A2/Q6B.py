...
def main():
      ...
      FeaturesTrainScaled = []
      for i in range(383):
            FeaturesTrainScaled.append([1, FloorArea_Scaled[i], NoOfBedrooms[i], NoOfBathrooms[i]])
      
      print("1) Using batch gradient without feature scaling")
      Coeff = [0, 0, 0, 0]
      LearningRateNoScaling = 0.00000001
      print("Initial coefficients: ")
      print(Coeff)
      Coeff = FindCoeffUsingBatchG(LearningRateNoScaling, FeaturesTrain, PriceTrain)
      print("Final coefficients are:")
      print(Coeff)
      GiveError(Price, FloorArea, NoOfBedrooms, NoOfBathrooms, Coeff)

      print("2) Using batch gradient with feature scaling")
      Coeff = [0, 0, 0, 0]
      LearningRateScaling = 0.001
      print("Initial coefficients: ")
      print(Coeff)
      Coeff = FindCoeffUsingBatchG(LearningRateScaling, FeaturesTrainScaled, PriceTrain)
      print("Final coefficients are:")
      print(Coeff)
      GiveError(Price, FloorArea_Scaled, NoOfBedrooms, NoOfBathrooms, Coeff)

      # Using Stochastic gradient without feature scaling
      print("3) Using Stochastic gradient without feature scaling")
      ...
      print("4) Using Stochastic gradient with feature scaling")
      LearningRateScaling = 0.005
      Coeff = [0, 0, 0, 0]
      print("Initial coefficients: ")
      print(Coeff)
      Coeff = FindCoeffUsingStochasticG(LearningRateScaling, FeaturesTrainScaled, PriceTrain)
      print("Final coefficients are:")
      print(Coeff)
      GiveError(Price, FloorArea_Scaled, NoOfBedrooms, NoOfBathrooms, Coeff)

      # Using Minibatch gradient without feature scaling for batch size = 20
      print("5) Using Minibatch gradient without feature scaling for batch size = 20")
      LearningRateNoScaling = 0.000000001
      Coeff = [0, 0, 0, 0]
      print("Initial coefficients: ")
      print(Coeff)
      Coeff = FindCoeffUsingMiniBatchG(LearningRateNoScaling, FeaturesTrain, PriceTrain)
      print("Final coefficients are:")
      print(Coeff)
      GiveError(Price, FloorArea, NoOfBedrooms, NoOfBathrooms, Coeff)

      # Using Minibatch gradient without feature scaling for batch size = 20
      print("6) Using Minibatch gradient with feature scaling for batch size = 20")
      LearningRateScaling = 0.002
      Coeff = [0, 0, 0, 0]
      print("Initial coefficients: ")
      print(Coeff)
      Coeff = FindCoeffUsingMiniBatchG(LearningRateScaling, FeaturesTrainScaled, PriceTrain)
      print("Final coefficients are:")
      print(Coeff)
      GiveError(Price, FloorArea_Scaled, NoOfBedrooms, NoOfBathrooms, Coeff)
